...
- Orbit-style 4-panel visualization
- Satellite ID extracted from TLE
"""
...
if master_file and target_files:
    try:
        ...
        for target in target_files:
            ...
            tle_lines = [line for line in target_text.splitlines() if line.startswith("1 ")]
            name = tle_lines[0].split()[1] if tle_lines else target.name.replace(".txt", "")
