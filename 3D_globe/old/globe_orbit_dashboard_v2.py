"""
Orbital Dashboard v2
- Enhanced Earth visibility
- Animated satellites (1 dot per sat)
- Clear hover labels
- Exports to interactive HTML
"""
...
def main():
    ...
    parser.add_argument("--html", default="orbit_dashboard_v2.html", help="Output HTML file")
    ...
    for sat_id, sat in satellites:
        ...
        # Single animated satellite dot at end of orbit
        if xs and ys and zs:
            fig.add_trace(go.Scatter3d(
                ...
                text=[f"{sat_id}<br>{labels[-1]}"],
                textposition="top center",
                hoverinfo='text'
            ))

    # Earth sphere — brighter and opaque
    ...
    fig.update_layout(
        title="🛰️ Orbital Globe Dashboard v2",
        scene=dict(
    ...
    print(f"✅ Dashboard saved as: {args.html}")
